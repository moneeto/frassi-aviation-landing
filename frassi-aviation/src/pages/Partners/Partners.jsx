...
import machxLogo from '../../assets/aboutUsImage_1.png';
import dragonLogo from '../../assets/react.svg';
    ...
    <section id="partners" style={{ minHeight: '100vh' }}>
      ...
      <Row className="justify-content-center align-items-start partners-row">
        <Col md="5" className="d-flex flex-column align-items-center partner-block">
          <img src={machxLogo} alt="Mach X" className="partner-logo" />
        ...
        <Col md="5" className="d-flex flex-column align-items-center partner-block">
          <img src={dragonLogo} alt="Dragon Flight" className="partner-logo" />
